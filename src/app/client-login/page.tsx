    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-zinc-900">
        ...
        <div className="absolute bottom-12 left-12 right-12 text-white">
          <h2 className="text-4xl font-bold mb-4 tracking-tight">Client Portal</h2>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-white border-none shadow-sm rounded-2xl">
          <CardHeader className="space-y-1 pt-12 pb-8">
            <CardTitle className="text-3xl font-medium text-center text-gray-900">Client Login</CardTitle>
          </CardHeader>
          <form action={action}>
